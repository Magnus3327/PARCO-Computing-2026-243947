/*
    ...
    convert it to Compressed Sparse Row (CSR) format, and perform Sparse Matrix-Vector Multiplication (SpMV) in sequential.

    It's an alternative versione of /src/spmvSequential.cpp with all the code in a single file for easier compilation and testing.
*/
#include <iostream>
#include <fstream>
#include <vector>
